...
module Formulary
  ...
  def self.load_formula_from_json!(name, json_formula_with_variations, flags:)
    ...
    formula_struct = Homebrew::API::FormulaStruct.from_hash(json_formula)
    ...
    klass = Class.new(::Formula) do
      ...
      if formula_struct.service?
        service do
          run(*formula_struct.service_run_args, **formula_struct.service_run_kwargs)
          name(**formula_struct.service_name_args)
